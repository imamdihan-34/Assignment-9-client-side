    ...
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 px-4">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl w-full max-w-lg shadow-xl">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-6 text-sm">
          Tutor:{" "}
          <span className="text-blue-600 font-semibold">{tutor.tutorName}</span>{" "}
          — {tutor.subject}
        </p>
        ...
        <form onSubmit={handleBooking} className="space-y-4">
          ...
          <div className="bg-blue-50 dark:bg-gray-700 rounded-xl p-4 text-sm text-gray-600 dark:text-gray-300 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span>
                Time: <span className="font-medium">{tutor.timeSlot}</span>
              </span>
            </div>
            <div className="flex items-center gap-2">
              <FiDollarSign className="text-blue-500 shrink-0" />
              <span>
                Fee: <span className="font-medium">${tutor.hourlyFee}/hr</span>
              </span>
            </div>
            <div className="flex items-center gap-2">
              <FiMapPin className="text-blue-500 shrink-0" />
              <span>
                Location: <span className="font-medium">{tutor.location}</span>
              </span>
            </div>
            <div className="flex items-center gap-2">
