      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-lg text-center">
            ...
            <h3 className="text-2xl font-bold mt-5">Trusted Tutors</h3>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-lg text-center">
            <Clock3 size={60} className="mx-auto text-cyan-600" />

            <h3 className="text-2xl font-bold mt-5">Flexible Schedule</h3>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-lg text-center">
            <Users size={60} className="mx-auto text-indigo-600" />

            <h3 className="text-2xl font-bold mt-5">Easy Learning</h3>
